...
Graph::Graph(int V)
{
 ...
 // function returns true if the directed graph has an eulerian cycle, otherwise returns false  
...
// This function returns true if all non-zero degree vertices of graph are strongly connected.
bool Graph::isSC()
{
...
// if the given array of strings can be chained to form cycle
