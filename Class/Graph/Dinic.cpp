...
struct Edge {
    ...
    // capacity
    int rev; 
    // To store index of reverse edge in adjacency list so that we can quickly find it.
};
// Residual Graph
class Graph {
...
// A DFS based function to send flow after BFS has figured out that there is a possible flow 
